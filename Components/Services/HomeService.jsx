...
import Styles from "../../Styles/Services/HomeService.module.css";
...
const HomeService = () => {
  ...
  const [level1Select, setLevel1Select] = useState("");
  ...
  return (
    <div className={Styles.accodianContainer}>
      <div className={Styles.selectText}>Please Select Service</div>
      {serviceL1?.map((ele) => (
        <Accordion expanded={ele === level1Select} style={{}}>
          <AccordionSummary
            ...
            onClick={() => setLevel1Select(ele === level1Select ? "" : ele)}
          >
            ...
            <div className={Styles.modalContainer}>
              ...
              <div className={Styles.buttonIcon}>
                ...
                >
                  ...
                  >
                    <span style={{ textAlign: "center" }}>Single Resource</span>
                  </div>
                </div>
                <div
                  style={{
